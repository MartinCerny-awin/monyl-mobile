...
describe("validator test", () => {
  ...
  it("minLength", () => {
    expect(validator.minLength(8)("ahoj")).toEqual(
  ...
  it("maxLength", () => {
    ...
    expect(validator.maxLength(4)("velry")).toEqual(
  ...
  it("equalWith", () => {
    ...
    expect(validator.equalWith("password")("a", { password: "b" })).toEqual(
      "Must be matched with password"
    );
    expect(
      validator.equalWith("password", "New password")("a", { password: "b" })
    ).toEqual("Must be matched with New password");
  });
});
